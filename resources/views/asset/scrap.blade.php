        ...
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-primary-dark">
                    <h3 class="block-title">Scrap Asset</h3>
                ...
                <div class="block-content font-size-sm">
                    <form method="post" action="{{route('scrap',$asset->id)}}" id="scrap-form{{$asset->id}}" >

                        {{ method_field('PUT') }}

                        {{csrf_field()}}

                        <input class="invisible" name="scrap" value="1">
                ...
                <div class="block-content block-content-full text-right border-top">
                    ...
                    <button type="button" class="btn btn-sm btn-primary"onclick="event.preventDefault();
                            document.getElementById('scrap-form{{$asset->id}}').submit();"><i class="fa fa-check mr-1"></i>Scrap</button>
                </div>
            </div>
        </div>
    </div>
